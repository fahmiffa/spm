                            ...
                            <div
                                ...
                                @if ($akreditasi->status == 5)
                                    <div class="flex gap-2">
                                        @if ($this->asesorTipe == 1)
                                            <x-secondary-button wire:click="saveAsesorEdpm">Simpan
                                                Draft</x-secondary-button>
                                            <x-primary-button wire:click="finalizeVerification"
                                                wire:confirm="Selesaikan verifikasi? Status akan berubah menjadi Visitasi.">Selesaikan
                                                & Verifikasi</x-primary-button>
                                        @else
                                            <x-primary-button wire:click="saveAsesorEdpm">Simpan</x-primary-button>
                                        @endif
                                    </div>
                                @endif
                            </div>
